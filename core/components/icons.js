// Icons — Lucide (https://lucide.dev, ISC license), inlined as SVG so there's
// no build step or dependency. One source of truth: components call icon(name).
...
const P = {
  ...
  reply: '<path d="M20 18v-2a4 4 0 0 0-4-4H4"/><polyline points="9 17 4 12 9 7"/>',
  ...
  "mail-open":
    '<path d="M21.2 8.4c.5.38.8.97.8 1.6v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V10a2 2 0 0 1 .8-1.6l8-6a2 2 0 0 1 2.4 0z"/><path d="m22 10-9.5 6a2 2 0 0 1-2 0L2 10"/>',
  "message-square":
...
// Catalog object-type glyphs (Lucide). Referenced by the `icon:` metadata in the
// ontology — added here so every object type renders its real glyph.
Object.assign(P, {
  "bar-chart":
...
P.chat = P["message-square"]; // backend names; same Lucide glyph
P.envelope = P.mail;
P.kanban = P["square-kanban"]; // backend names; same Lucide glyph
